  ...
  return (
      <DashboardLayout isCurrent={isCurrent} setIsCurrent={setIsCurrent} >
          <div>
            ...
            <motion.div 
              className="justify-center items-center flex bg-green-500 font-bold hover:bg-green-400 hover:border-green-500 w-32 h-32 rounded-full m-auto p-5 text-3xl border-b-4 border-b-green-600"
